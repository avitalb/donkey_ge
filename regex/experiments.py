...
def parse_args(args: List[str]) -> Dict[str, Any]:
    ...
    parser.add_argument(
        "--output_folder", type=str, required=True, help="Name of output folder E.g. results",
    )
    parser.add_argument(
        "--n_folds", type=int, default=2, help="Number of folds. E.g. 10",
    )
    parser.add_argument(
        "--n_runs", type=int, default=2, help="Number of independent runs per fold. E.g. 30",
    )
